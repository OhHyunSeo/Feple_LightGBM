...
CLASS_DIR = 'json_merge/classification_merge_output'
...
os.makedirs('columns_extraction_all/preprocessing', exist_ok=True)
df_labels.to_csv('columns_extraction_all/preprocessing/session_labels.csv', index=False, encoding='utf-8-sig')
...
# 1) 불러오기
df_feat   = pd.read_csv('output/text_features_all_v4.csv', encoding='utf-8-sig')
df_labels = pd.read_csv('columns_extraction_all/preprocessing/session_labels.csv', encoding='utf-8-sig')  # 혹은 위에서 만든 df_labels.to_csv(...) 파일
...
train.to_csv('dataset/train.csv', index=False, encoding='utf-8-sig')
val.to_csv  ('dataset/val.csv',   index=False, encoding='utf-8-sig')
test.to_csv ('dataset/test.csv',  index=False, encoding='utf-8-sig')
print("✅ Dataset saved under dataset/")