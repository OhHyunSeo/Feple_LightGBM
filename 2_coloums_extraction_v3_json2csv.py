...
files = sorted(glob.glob(
    '/content/drive/MyDrive/Gwangjin_gu/preprocessing_call/json_merge_all/integration_data_v3/final_merged_*.json'
))
checkpoint_path = '/content/drive/MyDrive/Gwangjin_gu/preprocessing_call/colab/all/checkpoint.txt'
output_csv      = '/content/drive/MyDrive/Gwangjin_gu/preprocessing_call/colab/all/text_features_all_v4.csv'
