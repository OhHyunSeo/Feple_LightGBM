...
OUTPUT_DIR = 'json_merge_all/summary_merge_output_v3'      # 병합 결과를 저장할 폴더
os.makedirs(OUTPUT_DIR, exist_ok=True)
...
# 1) 병합된 요약 파일들이 있는 폴더
INPUT_DIR = 'json_merge_all/summary_merge_output_v3'
...
OUTPUT_DIR = 'json_merge_all/qa_merge_output_v3'      # 병합 결과를 저장할 폴더
os.makedirs(OUTPUT_DIR, exist_ok=True)
...
# 1) 폴더 경로 설정
CLASS_DIR   = 'json_merge_all/classification_merge_output_v3' # 분류 파일 보관 폴더
SUMMARY_DIR = 'json_merge_all/summary_merge_output_v3'        # 요약 파일 보관 폴더
QNA_DIR     = 'json_merge_all/qa_merge_output_v3'            # 질의응답 파일 보관 폴더
FINAL_DIR   = 'json_merge_all/integration_data_v3'          # 최종 머지 파일 저장 폴더
